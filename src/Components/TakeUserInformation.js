...
//////////functions
  ...
  return (
    <div className={ isBtnClicked ? "user-logo__information-container": "user-logo__information-container hide"}>
      ...
      <div className="user-informmation-container">
        <div className="user-informmation-wrapper">
          ...
          <form onSubmit={setDataInLocalStorage}>
            ...
            <br />
            <input type="email" required onChange={e => setEmail(e.target.value)} value={email}></input><br />
            <label>Role</label><br />
            <select id="roles" type="text" required onChange={e => setRole(e.target.value)} value={role}>
              <option value="Admin">Admin</option>
              <option value="Owner">Owner</option>
              <option value="Sales">Sales</option>
            </select><br />
            <div className="btn-wrapper">
            <button id="cancel" onClick={clickedOnCancel}>Cancel</button>
